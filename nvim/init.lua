...
local mini_path = pack_path .. '/deps/start/mini.nvim'
local mini_repo = 'https://github.com/nvim-mini/mini.vim'
...
-- vim.opt.undodir = vim.fn.stdpath("cache") .. "undo" -- Undo directory
...
vim.opt.foldminlines = 1                                -- Close folds with at least 1 line
