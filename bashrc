...
__conda_setup="$('/home/accdias/miniforge3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/accdias/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/home/accdias/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/home/accdias/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/home/accdias/miniforge3/etc/profile.d/mamba.sh" ]; then
